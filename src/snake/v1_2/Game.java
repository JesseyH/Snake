 ...
 * <p>
 * version 1.2 features three food items: the regular apple Mice and Poison.
 * Normal game rules apply: Watch out for walls, don't eat yourself and score as
 * many points as you can!
 * <p>
 * <h2>Release Notes</h2>
 * <h3>New Features</h3>
 * <ul>
 * <li>Added control information at the start menu
 * <li>Display for a message when eating
 * <li>Added Timer
 * <li>Menu now waits for input before executing the game
 * <li>Restart option at end game
 * </ul>
 * <h3>Fixed Issues/Behavioral Changes</h3>
 * <ul>
 * <li>The timer now starts after the first command is entered instead of after
 * the start menu closes
 * </ul>
 * 
 * @author Jessey Harrymanoharan
 * @version 1.2
 * @since 2017-10-25 18:20:00
 */
public class Game {
	// Game GUI
